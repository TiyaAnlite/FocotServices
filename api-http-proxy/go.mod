module github.com/TiyaAnlite/FocotServices/api-http-proxy

go 1.19

require (
	github.com/TiyaAnlite/FocotServices/client-http-proxy v0.0.0-20230315092311-14b891cf4bef
	github.com/TiyaAnlite/FocotServicesCommon v0.0.0-20230321040215-14e3a46766fb
